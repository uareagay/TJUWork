...
struct OutboxListModel: Codable {
    let status: Bool
    let code: Int
    let message: String
...
extension OutboxListData {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(OutboxListData.self, from: data)
    }
