...
- (void)viewDidLoad {
    ...
    if (![self isIpad]) {
        ...
        UIToolbar *keyboardToolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(-8, -8, 60, 60)];
        [toolbarCropper addSubview:keyboardToolbar];
        
        self.keyboardItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"ZSSkeyboard@2x.png"] style:UIBarButtonItemStylePlain target:self action:@selector(dismissKeyboard)];
...
- (void)buildToolbar {
    ...
    CGFloat toolbarWidth = items.count == 0 ? 0.0f : (CGFloat)(items.count * 45) - 10;
...
- (void)setContentHeight:(float)contentHeight {
    ...
    NSString *js = [NSString stringWithFormat:@"zss_editor.contentHeight = %f;", contentHeight-120];
    [self.editorView stringByEvaluatingJavaScriptFromString:js];
